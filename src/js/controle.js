...
import { changeMethode } from "./main";

// import * as THREE from 'three';
export let isPaused = false;  // Exportez isPaused pour l'utiliser dans d'autres modules
...
// document.getElementById('antDistance').addEventListener('change', function(event) {
//     antSettings.minDistance = Number(event.target.value);
// });
...
//         antSettings.minDistance += 0.5;
//         document.getElementById('antDistance').value = antSettings.minDistance;
//     }
